...
/*
 * in java 8 you can have a OPTIONAL type, which is a data type that may or 
 * may not have a value
 */
public class Main {
	/*
	 * The optional data type can only have as its generic a Object, cannot be
	 * a primitive (as is the case with all Generic types
	 */
	/*
